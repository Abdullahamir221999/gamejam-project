...
public class TurqoiseBullet : MonoBehaviour
{
    public float life = 3;
    private Rigidbody turqoisebulletRb;
    public int bulletDamage = 100;
    public ParticleSystem splat;
    void Start()
    {
        turqoisebulletRb = GetComponent<Rigidbody>();
    }
    void Awake()
    {
    ...
    {
        if (collision.gameObject.CompareTag("TurquoiseEnemy") /*|| collision.gameObject.CompareTag("BigPurpleEnemy")*/)
        {
